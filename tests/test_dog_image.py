...
class TestGrayscaleDogImage(unittest.TestCase):
    def setUp(self):
        ...
        self.gray_img = GrayscaleDogImage(self.gray_img_array, "какая-то ссылка 1", "какая-то порода 1")
    ...
    def test_image_addition(self):
        ...
        """
        other = GrayscaleDogImage(self.gray_img_array, "какая-то ссылка 2", "какая-то порода 2")
...
class TestColorDogImage(unittest.TestCase):
    def setUp(self):
        ...
        self.rgb_img = ColorDogImage(self.rgb_img_array, "какая-то ссылка 3", "какая-то порода 3")
    ...
    def test_image_addition(self):
        ...
        """
        other = ColorDogImage(self.rgb_img_array, "какая-то ссылка 4", "какая-то порода 4")
