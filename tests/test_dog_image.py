...
from dogs.dogs_lib import ColorDogImage, GrayscaleDogImage, DogImageProcessor
...
class TestGrayscaleDogImage(unittest.TestCase):
    def setUp(self):
        ...
        self.gray_img = GrayscaleDogImage(self.gray_img_array, "какая-то рандомная ссылка 1", "какая-то порода 1")
    ...
    def test_image_addition(self):
        ...
        """
        other = GrayscaleDogImage(self.gray_img_array, "какая-то рандомная ссылка 2", "какая-то порода 2")
    ...
    def test_custom_edges(self):
        ...
        self.assertTrue(
            isinstance(edges, GrayscaleDogImage) and edges.image.shape == (62, 62),
            "Edge detection должен возвращать GrayscaleDogImage с размером (62, 62)"
        )
...
class TestColorDogImage(unittest.TestCase):
    def setUp(self):
        ...
        self.rgb_img = ColorDogImage(self.rgb_img_array, "какая-то рандомная ссылка 3", "какая-то порода 3")
    ...
    def test_image_addition(self):
        ...
        """
        other = ColorDogImage(self.rgb_img_array, "какая-то рандомная ссылка 4", "какая-то порода 4")
    ...
    def test_custom_edges(self):
        ...
        self.assertTrue(
            isinstance(edges, GrayscaleDogImage) and edges.image.shape == (62, 62),
            "Edge detection на RGB должен возвращать GrayscaleDogImage с размером (62, 62)"
        )
